...
class BqVolumeRecoveryGuardTests(unittest.TestCase):
    ...
    def test_grvt_dynamic_extreme_allows_bounded_release_when_both_sides_exceed_soft(self) -> None:
            ...
            plan.update(
                {
                    ...
                    "short_pause_reasons": ["extreme_volatility_defensive", "inventory_soft"],
                    "buy_orders": [
