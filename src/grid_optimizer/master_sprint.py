...
SPRINT_BOARD_CONFIGS: tuple[SprintBoardConfig, ...] = (
    ...
    SprintBoardConfig(
        ...
        label="Altcoins 大师赛",
        phase_label="第 2 期",
        resource_id=int(os.environ.get("GRID_MASTER_SPRINT_ALTCOINS_RESOURCE_ID") or 52060),
        referer="https://www.binance.com/zh-CN/activity/trading-competition/altcoinsprint-2026wk2-new?ref=YEK2JZJT",
        start_at="2026-04-28T08:00:00+08:00",
        end_at="2026-05-05T07:59:00+08:00",
        entry_threshold=500.0,
        threshold_unit="USDT",
