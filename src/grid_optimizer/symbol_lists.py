...
DEFAULT_SYMBOL_LISTS: dict[str, list[str]] = {
    "monitor": ["BILLUSDT", "AIGENSYNUSDT", "BTCUSDC", "ETHUSDC", "XAUUSDT", "XAGUSDT", "CLUSDT", "BZUSDT", "ORDIUSDC", "TRUMPUSDC"],
    "competition": ["BILLUSDT", "AIGENSYNUSDT", "BTCUSDC", "ETHUSDC", "XAUUSDT", "XAGUSDT", "CLUSDT", "BZUSDT", "ORDIUSDC", "TRUMPUSDC"],
}
