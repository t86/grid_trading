...
PROFILES: dict[str, dict[str, dict[str, Any]]] = {
    "BTCUSDC": {
        "aggressive": {
            ...
            "best_quote_maker_volume_loss_per_10k_hard": 0.7,
            ...
            "pause_buy_position_notional": 550.0,
            "pause_short_position_notional": 550.0,
            "threshold_position_notional": 650.0,
            "max_actual_net_notional": 700.0,
            ...
            "volatility_entry_pause_10s_abs_return_ratio": 0.00045,
            "volatility_entry_pause_10s_amplitude_ratio": 0.00070,
            "volatility_entry_pause_30s_abs_return_ratio": 0.00075,
            "volatility_entry_pause_30s_amplitude_ratio": 0.00120,
            "volatility_entry_pause_1m_abs_return_ratio": 0.00120,
            "volatility_entry_pause_1m_amplitude_ratio": 0.00180,
            "volatility_entry_pause_3m_abs_return_ratio": 0.00250,
            "volatility_entry_pause_3m_amplitude_ratio": 0.00350,
    ...
    "XAGUSDT": {
        ...
        "conservative": {
            ...
            "sell_levels": 6,
            "max_new_orders": 16,
            "max_position_notional": 380.0,
            "max_short_position_notional": 380.0,
            "pause_buy_position_notional": 220.0,
            "pause_short_position_notional": 220.0,
            "threshold_position_notional": 280.0,
            "max_total_notional": 1800.0,
            "rolling_hourly_loss_limit": 2.5,
            "max_actual_net_notional": 220.0,
            "take_profit_min_profit_ratio": 0.0,
            "hard_loss_forced_reduce_enabled": True,
            "hard_loss_forced_reduce_target_notional": 70.0,
            "hard_loss_forced_reduce_max_order_notional": 30.0,
            "hard_loss_forced_reduce_unrealized_loss_limit": 0.45,
            "adverse_reduce_short_trigger_ratio": 0.0022,
            "adverse_reduce_long_trigger_ratio": 0.0022,
            "adverse_reduce_target_ratio": 0.25,
            "elastic_loss_per_10k_sprint": 0.08,
            "elastic_loss_per_10k_cruise": 0.25,
            "elastic_loss_per_10k_defensive": 0.50,
            "elastic_loss_per_10k_cooldown": 0.85,
            ...
            "volatility_entry_pause_30s_abs_return_ratio": 0.0011,
            "volatility_entry_pause_1m_abs_return_ratio": 0.0018,
            "volatility_entry_pause_1m_amplitude_ratio": 0.0028,
            "volatility_entry_pause_3m_abs_return_ratio": 0.0036,
            "volatility_entry_pause_3m_amplitude_ratio": 0.0052,
        },
    },
}
